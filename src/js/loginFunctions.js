...
export async function signUpHandler (signUpFields) {
  ...
  signUpFields.forEach(element => {
    ...
    } else if (signUpFields[3].value !== 'l&d') {
      postData = false
      window.alert(`Fill in ${element.id.split('-')[0]} Field to Continue`)
    }
  })
...
/**
 *
 * @param departmentFieldComponents
 */
export function displayDepartmentField (departmentFieldComponents) {
  departmentFieldComponents.forEach(element => {
 ...
 * @param departmentFieldComponents
 */
export function hideDepartmentField (departmentFieldComponents) {
  departmentFieldComponents.forEach(element => {
