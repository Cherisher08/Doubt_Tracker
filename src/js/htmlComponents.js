...
export const departmentSelectFields = document.querySelectorAll('.department-select-field')
export const profilePictureInps = document.querySelector('#profile-picture-inp')
export const profilePictures = document.querySelector('.profile-picture')
